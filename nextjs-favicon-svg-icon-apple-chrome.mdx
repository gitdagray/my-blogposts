...
It also generated a file named `site.webmanifest`, but I will show my own manifest file below. You can also discard the other generated files.
...
**Note:** You only need to provide info for the two `android-chrome` icons in this file. 
...
_And you should have the `android-chrome` icons in your `public` folder._ I'm using an `images` folder inside, so notice my manifest file has `/images/icon-192.png`. You do not have to specify your `public` folder in the manifest.
