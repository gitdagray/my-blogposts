...
to provide metadata for a webpage. Colby Fayock provided a nice explainer article called "[_What is Open Graph and how can I use it for my website?_](https://www.freecodecamp.org/news/what-is-open-graph-and-how-can-i-use-it-for-my-website/)" that was published by freeCodeCamp. I highly recommend it. 
