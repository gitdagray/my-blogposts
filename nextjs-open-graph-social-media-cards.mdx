...
date: '2023-11-22'
modified: '2023-11-22'
tags: ['next.js','nextjs','seo','metadata']
---
...
to provide metadata for a webpage. Colby Fayock provided a nice explainer article called [What is Open Graph and how can I use it for my website?](https://www.freecodecamp.org/news/what-is-open-graph-and-how-can-i-use-it-for-my-website/) that was published by freeCodeCamp. I highly recommend it. 
...
If you don't provide Open Graph metadata in your blog, a post might look like this when you share it:
        ...
        <CustomImage src="https://raw.githubusercontent.com/gitdagray/my-blogposts/main/images/tweet-without-open-graph.jpg" alt="Tweet without Open Graph metadata" width={1080} height={727} />

But if you do provide Open Graph metadata, a shared post might look like this instead: 

        <CustomImage src="https://raw.githubusercontent.com/gitdagray/my-blogposts/main/images/tweet-with-open-graph.jpg" alt="Tweet with Open Graph metadata" width={1079} height={1469} />
...
openGraph: {
    ...
    images: [
      {
        url: 'https://res.cloudinary.com/dyfvfjgjw/image/upload/v1700518252/og-card.png',
        secureUrl: 'https://res.cloudinary.com/dyfvfjgjw/image/upload/v1700518252/og-card.png',
        width: 1200,
        height: 630,
...
- I'm hosting the image for my homepage at [Cloudinary](https://cloudinary.com/) right now, but you could host yours in your GitHub repo or anywhere you want. 
...
<meta property="og:image" content="https://res.cloudinary.com/dyfvfjgjw/image/upload/v1700518252/og-card.png">
<meta property="og:image:secure_url" content="https://res.cloudinary.com/dyfvfjgjw/image/upload/v1700518252/og-card.png">
...
<meta name="twitter:image" content="https://res.cloudinary.com/dyfvfjgjw/image/upload/v1700518252/og-card.png">
...
The static approach isn't too efficient for blog article pages. They should provide page specific data, and just like your Next.js blog pages, you can create this metadata dynamically. 

I previously discussed generating metadata for dynamic post pages in a blog post about [ordering and merging metadata in Next.js](https://www.davegray.codes/posts/nextjs-ordering-merging-metadata). The examples I show you below will be part of a larger metadata object that is returned by the [`generateMetadata` function](https://nextjs.org/docs/app/api-reference/functions/generate-metadata#generatemetadata-function).
...
You can style the created images with CSS just like you would the rest of your app. This approach uses the `edge` runtime to speed up things up, too. 

_Why didn't I choose to use this feature_? 

In the end, it seems like a quick way to generate generic images with a color background and text overlay. You could spend more time with it to pull in unique cover images, too, but I already easily pull images from my GitHub repo. And most social media sites will already pull in your article title from your Open Graph metadata and compile a card with that text and your image. 

I may spend some more time with Next.js image generation in the future. The [ImageResponse API](https://nextjs.org/docs/app/api-reference/functions/image-response) it uses looks fun, and I think I could use it to generate a dynamic social card for my homepage.

If the image generation approach has peaked your curiosity, don't wait for me - go for it!

Until next time, you can share any of my [blog posts](https://www.davegray.codes/) to see how the different social media platforms create social media cards compiled from my Open Graph and Twitter metadata. 
