...
My recent articles have focused on [metadata](https://www.davegray.codes/posts/nextjs-ordering-merging-metadata) and the overall search engine optimization (SEO) of Next.js websites by showing how to build [sitemaps](https://www.davegray.codes/posts/nextjs-how-to-build-sitemap-robots-txt) and [RSS feeds](https://www.davegray.codes/posts/nextjs-how-to-build-an-rss-feed). However, you won't see how those things impact your website if you don't keep track of how your website performs. 
...
You can sign up on the [Google Analytics website](https://marketingplatform.google.com/about/analytics/).
...
## 2. Adding Google Analytics JS to Your Next.js Website 
...
This part of the Google Analytics JS code snippet is provided from Google between traditional opening and closing HTML `<script>` tags. In Next.js, when you use the `<Script>` component in this way, you need to wrap the enclosed JS code with curly braces { } and backticks. You also need to give the opening tag an `id="gtag"` attribute. 
...
Finally, you will need to deploy your site to publish the changes to the web, and you should be able to tell Google Analytics to verify it can find the code on your deployed Next.js website. 

There's a lot you can do in the Google Analytics dashboard. I recommend you use the setting that lets you connect the dashboard to your [Google Search Console](https://search.google.com/search-console/about) where you [submit your sitemap](https://www.davegray.codes/posts/nextjs-how-to-submit-your-sitemap).