...
You can achieve in two different ways with Next.js:
...
<script src="https://www.googletagmanager.com/gtm.js?id=G-570ZF8G2JR" id="_next-gtm" data-ntpc="GTM" data-nscript="afterInteractive"></script>
```
