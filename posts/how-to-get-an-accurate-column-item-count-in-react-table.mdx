...
description: 'How to get an Accurate Column Item Count in React Table.'
date: '2024-01-26'
modified: '2024-01-26'
...
The only problem with this data: It has a lot of null values saved over the last approximately 15 years. 
...
The code in the docs example giving the column item count for the filter input placehold:
...
You would want to handle this differently if you were filtering boolean or number data. 

In this example, I'm filtering a text field and only looking for a truthy return in the filter. 
...
Here is part to add in your accessor:
