...
description: 'Let your boss and co-workers download their own exports.'
date: '2024-02-18'
modified: '2024-02-18'
...
```
You can find a similar example using Express in the [SheetJS docs](https://docs.sheetjs.com/docs/solutions/output#example-server-responses). 
...
You can find all of the appropriate methods in the [SheetJS docs](https://docs.sheetjs.com/), but here is how I allow CSV downloads, too. 
