...
I believe any of the above solutions were just a VS Code update away from theirs not working as well. 
...
I know he was trying to help, but he suggested what I demonstrated in the video was NOT possible with VS Code as I had it setup: 
...
Recent editions of VS Code give you red squiggly lines in VS Code for this formatting mistake. You should be able to easily see it and correct it on your own. 
...
Instead of considering this a formatting error, it seems VS Code is now handling this as invalid code - an error - and something that you should fix instead of a formatter.

That said, we all now know **VS Code was once capable of auto-correcting unwanted line-indentations**. 

It sure would be cool if VS Code did this again.