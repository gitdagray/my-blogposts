...
I downloaded [`VS Code version 1.70.2`](https://code.visualstudio.com/updates/v1_70) and installed it.
...
Instead of considering this to be a formatting issue, it seems VS Code is now handling this as simply invalid code - _an error_. Their opinion is this is something you should identify and fix instead of a formatter.
