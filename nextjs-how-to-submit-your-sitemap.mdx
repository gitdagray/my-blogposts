...
To provide for verification metadata, Next.js supports a [verification object](https://nextjs.org/docs/app/api-reference/functions/generate-metadata#verification) in the metadata type it creates your project's metadata tags from. I previously discussed [creating a metadata object](https://www.davegray.codes/posts/nextjs-ordering-merging-metadata) for my Next.js blog and that discussion might help you understand the overall approach.
...
```
Now you can go back to the search console for Google to verify your site ownership. This should happen very quickly. 
...
And now the wait begins for your site to be indexed. I know you may be anxious (_just like I was_) to see results, but Google will usually take a few days before it crawls and indexes your site. 
